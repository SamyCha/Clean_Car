...
User.create!(email: "test2@test", password: "test", address: "Ottawa, Canada", phonenumber: Faker::PhoneNumber.cell_phone)
# Cleaners in France
...
User.create!(firstname: Faker::Name.first_name, lastname: Faker::Name.last_name, email: "test12@test", password: "test", address: "Argentine", phonenumber: Faker::PhoneNumber.cell_phone, cleaner: true)
# Categories
