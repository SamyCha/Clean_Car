...
# Categories
Category.create!(name: "small", price_cents: 1000)
...
# Cleanings
# as stated on Trello, cleaning_status available are "pending", "accepted", "confirmed" or "canceled" and "complete" when end_photos and "archived" when client use button hide in dashboard
